...
public class WinJudge {   //胜利判定的三个用例,行列对角线胜利
    ...
    boolean exp;
    public WinJudge(String str1,String str2,String str3,String str4,String str5,String str6,String str7,String str8,String str9,boolean exp) {
    ...
    public static Collection testDataset() {
        return Arrays.asList(new Object[]{"X","X","X","","","","","","",true}, new Object[]{"O","O","O","","","","","","",true}, new Object[]{"X","","","X","","","X","","",true}, new Object[]{"O","","","O","","","O","","",true},new Object[]{"O","","","","O","","","","O",true},new Object[]{"X","","","","X","","","","X",true});
    }

    @Test
    public void PlayChess() {
            Assert.assertTrue(this.testObj.getResult(true) == this.exp);
    }
}
